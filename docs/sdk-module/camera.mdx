...
public void openCamera() {
    TruvideoSdkCamera.getInstance().start(
        // This configuration parameter changes the camera config
        new TruvideoSdkCameraConfiguration(
        ...
        new TruvideoSdkCameraCallback() {
            @Override
            public void onResult(List<TruvideoSdkCameraMedia> media) {
